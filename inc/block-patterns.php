 ...
 * @return void
 */
function spiritwestuc_register_block_patterns() {
	$block_pattern_categories = array(
		'featured' => array( 'label' => __( 'Featured', 'spiritwestuc' ) ),
		'footer'   => array( 'label' => __( 'Footers', 'spiritwestuc' ) ),
		'header'   => array( 'label' => __( 'Headers', 'spiritwestuc' ) ),
		'query'    => array( 'label' => __( 'Query', 'spiritwestuc' ) ),
		'pages'    => array( 'label' => __( 'Pages', 'spiritwestuc' ) ),
	);
	 ...
	 * }
	 */
	$block_pattern_categories = apply_filters( 'spiritwestuc_block_pattern_categories', $block_pattern_categories );
	 ...
	 */
	$block_patterns = apply_filters( 'spiritwestuc_block_patterns', $block_patterns );

	foreach ( $block_patterns as $block_pattern ) {
		$pattern_file = get_theme_file_path( '/inc/patterns/' . $block_pattern . '.php' );

		register_block_pattern(
			'spiritwestuc/' . $block_pattern,
			require $pattern_file
		);
	}
}
add_action( 'init', 'spiritwestuc_register_block_patterns');
